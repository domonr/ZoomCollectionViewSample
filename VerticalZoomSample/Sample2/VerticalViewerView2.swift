...
class VerticalViewerView2: VerticalViewerView {
...
extension VerticalViewerView2: UICollectionViewDataSource {
...
extension VerticalViewerView2: UICollectionViewDelegateFlowLayout {
...
extension VerticalViewerView2 {
    ...
    @objc func didDoubleTap(_ sender: UITapGestureRecognizer) {
        ...
        if self.scrollView.zoomScale > self.scrollView.minimumZoomScale {
            ...
            let point = sender.location(in: self.zoomView)
